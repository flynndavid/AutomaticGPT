...
export const CORE_FEATURES = {
  ...
  enableConversationManagement: getBooleanEnvVar('EXPO_PUBLIC_ENABLE_CONVERSATION_MANAGEMENT', true),
...
export const FEATURE_CATEGORIES = {
  ui: ['enableVoiceInput', 'enableDarkMode', 'enableHapticFeedback', 'enableAnimations', 'enableThemeCustomization'] as const,
  auth: [
    'enableAuth',
    'enableSocialAuth',
    'enableProfile',
